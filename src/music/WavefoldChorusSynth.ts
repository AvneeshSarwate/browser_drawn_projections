...
echoFdbk = hslider("EchoFdbk", 0.3, 0.01, 0.99, 0.01);
echoTime = hslider("EchoTime", 0.3, 0.01, 0.99, 0.01);

env2 = gate : en.adsr(0.01, 0.1, 0.2, modRelease);

sawFilt = os.squareN(5, freq*1.01) : fi.lowpass(4, freq*8);
oscSig = ((os.osc(freq))) + sawFilt*0.2;
...
export class WavefoldChorusVoice implements MPEVoiceGraph {
  id: number
