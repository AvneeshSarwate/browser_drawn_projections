...
`;
export const EdgeFragmentSource = `// Auto-generated by wgsl fragment generator. DO NOT EDIT.
varying vUV: vec2<f32>;
uniform uniforms_channelMode: u32;
uniform uniforms_blackLevel: f32;
uniform uniforms_strength: f32;
...
#define CUSTOM_FRAGMENT_MAIN_BEGIN
  ...
  let color = edgeEffect(uv_local, uniforms_value, src, srcSampler);
...
export function createEdgeMaterial(scene: BABYLON.Scene, options: EdgeMaterialOptions = {}): EdgeMaterialHandles {
  const name = options.name ?? 'EdgeMaterial';
  ...
  BABYLON.ShaderStore.ShadersStoreWGSL[fragmentShaderName] = EdgeFragmentSource;
