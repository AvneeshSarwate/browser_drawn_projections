...
import { CustomShaderEffect, type ShaderSource } from '../shaderFXBabylon';
...
export class LayerBlendEffect extends CustomShaderEffect<LayerBlendUniforms, LayerBlendInputs> {
  ...
  constructor(engine: BABYLON.WebGPUEngine, inputs: LayerBlendInputs, width = 1280, height = 720, sampleMode: 'nearest' | 'linear' = 'linear') {
    super(engine, inputs, {
