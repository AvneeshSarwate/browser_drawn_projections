...
`;
export const LevelFragmentSource = `// Auto-generated by wgsl fragment generator. DO NOT EDIT.
varying vUV: vec2<f32>;
uniform uniforms_clampInputMode: u32;
uniform uniforms_invert: u32;
uniform uniforms_blackLevel: f32;
...
#define CUSTOM_FRAGMENT_MAIN_BEGIN
  ...
  let color = levelEffect(uv_local, uniforms_value, src, srcSampler);
...
export function createLevelMaterial(scene: BABYLON.Scene, options: LevelMaterialOptions = {}): LevelMaterialHandles {
  const name = options.name ?? 'LevelMaterial';
  ...
  BABYLON.ShaderStore.ShadersStoreWGSL[fragmentShaderName] = LevelFragmentSource;
