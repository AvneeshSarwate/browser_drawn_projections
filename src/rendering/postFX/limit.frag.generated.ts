...
`;
export const LimitFragmentSource = `// Auto-generated by wgsl fragment generator. DO NOT EDIT.
varying vUV: vec2<f32>;
uniform uniforms_minFunction: u32;
uniform uniforms_maxFunction: u32;
uniform uniforms_minValue: f32;
...
#define CUSTOM_FRAGMENT_MAIN_BEGIN
  ...
  let color = limitEffect(uv_local, uniforms_value, src, srcSampler);
...
export function createLimitMaterial(scene: BABYLON.Scene, options: LimitMaterialOptions = {}): LimitMaterialHandles {
  const name = options.name ?? 'LimitMaterial';
  ...
  BABYLON.ShaderStore.ShadersStoreWGSL[fragmentShaderName] = LimitFragmentSource;
