...
export function createTransformMaterial(scene: BABYLON.Scene, options: TransformMaterialOptions = {}): TransformMaterialHandles {
  ...
  BABYLON.ShaderStore.ShadersStoreWGSL[fragmentShaderName] = TransformFragmentSource;
...
export class TransformEffect extends CustomShaderEffect<TransformUniforms, TransformInputs> {
  ...
  constructor(engine: BABYLON.WebGPUEngine, inputs: TransformInputs, width = 1280, height = 720, sampleMode: 'nearest' | 'linear' = 'linear') {
    super(engine, inputs, {
