...
fn canvasPaintSample(uv: vec2f, source: texture_2d<f32>, samplerRef: sampler) -> vec4f {
...
#define CUSTOM_FRAGMENT_MAIN_BEGIN
  let color = canvasPaintSample(input.vUV, src, srcSampler);
...
function createCanvasPaintMaterial(scene: BABYLON.Scene, name = 'CanvasPaintMaterial'): BABYLON.ShaderMaterial {
  return new BABYLON.ShaderMaterial(name, scene, {
    vertexSource: CANVAS_PAINT_VERTEX_SOURCE,
    fragmentSource: CANVAS_PAINT_FRAGMENT_SOURCE,
  }, {
