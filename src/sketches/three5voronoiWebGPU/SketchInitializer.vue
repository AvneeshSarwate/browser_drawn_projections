...
onMounted(() => {
  ...
  appState.threeRenderer = new THREE.WebGPURenderer({ canvas: document.getElementById('threeCanvas') as HTMLCanvasElement, alpha: true })
  appState.threeRenderer.setClearColor(new THREE.Color(0x000000), 0)
})
